...
# Kernel modules
# Ship every .ko in the ramdisk set (modules.load only controls load *order*;
# listing just those drops transitive deps like mtk-mbox / tinysys IPI /
# reboot-mode and first-stage module loading fails -> bootloop).
